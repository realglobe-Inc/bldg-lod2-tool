...
def CreateModel(
  ...
  # 作成に使用するためのデータを作成
  preprocess = Preprocess(grid_size=grid_size, image_size=image_size, expand_rate=expand_rate)
  rgb_image, depth_image = preprocess.preprocess(cloud, min_ground_height, shape)
